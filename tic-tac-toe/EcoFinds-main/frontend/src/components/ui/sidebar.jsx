...
>(
  (
    ...
    const setOpen = React.useCallback(
      (value((value) => boolean)) => {
        const openState = typeof value === "function" ? value(open) (setOpenProp) {
...
const SidebarGroupLabel = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div"> & { asChild?(({ className, asChild = false, ...props }, ref) => {
...
const SidebarGroupAction = React.forwardRef<
  HTMLButtonElement,
  React.ComponentProps<"button"> & { asChild?(({ className, asChild = false, ...props }, ref) => {
...
const SidebarMenuAction = React.forwardRef<
  HTMLButtonElement,
  React.ComponentProps<"button"> & {
    asChild??(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  const Comp = asChild ? Slot "button"
